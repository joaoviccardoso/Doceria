       ...
       <nav className='nav-navegacaoCliente'>
            <ul className='ul-navegacaoCliente'>
                ...
                <li className='link-navegacaoCliente'><Link to={'/minhaConta/meusPedidos'}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" fill="currentColor" class="bi bi-card-list" viewBox="0 0 16 16">
                ...
                <li className='link-navegacaoCliente'><Link to={'/minhaConta/favorito'}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" fill="currentColor" class="bi bi-list-stars" viewBox="0 0 16 16">
